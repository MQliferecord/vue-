  ...
  <div class="trade-container">
    ...
    <div class="trade">
      ...
      <div class="receiveInfo">
        寄送至:
        <span>{{ this.defaultAddr.fullAddress }}</span>
        收货人：<span>{{ this.defaultAddr.consignee }}</span>
        <span>{{ this.defaultAddr.phoneNum }}</span>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    async submitOrder() {
      ...
      let result = await this.$API.reqPayInfo(data,tradeNo);
      if(result.code ==200){
