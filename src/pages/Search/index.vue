  ...
  <div>
    ...
    <div class="main">
      <div class="py-container">
        ...
        <!--selector-->
        <SearchSelector @tradeMarkInfo="tradeMarkInfo" @attrInfo="attrInfo(attr,attrValue)"/>
          ...
          <div class="goods-list">
            <ul class="yui3-g">
              <li class="yui3-u-1-5" v-for="(good,index) in goodsList" :key="index">
                <div class="list-wrap">
                  <div class="p-img">
                    <router-link :to="`/d-etail/${good.id}`">
...
export default {
  ...
  computed:{
    ...
    ...mapstate({total:state=>state.search.searchlist})
  },
  methods: {
    getData(){
      this.$store.dispatch('getReqSearch',this.searchParams);
    },
    removeCategoryName(){
    ...
    attrInfo(){
      let props = `${attrId}:${attrValue}:${attrId.attrName}`;
